...
public class SolitareScript : MonoBehaviour
{
    ...
    void Shuffle<T>(List<T> list)  //fishers random shuffle
    {
     ...
     IEnumerator DealCard()
    {
        for (int i = 0; i < 7; i++)
        {
            ...
            foreach (string card in bottoms[i])
            {
                ...
                yOffset = yOffset + 0.3f;   //pozicija karata koja se slažu jedna na drugu
